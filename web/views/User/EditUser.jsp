...
<div class="w3-panel w3-teal" style="margin-bottom: 0; margin-top: 0">
    <h2 class="w3-text-white" style="text-shadow:1px 1px 0 #444">Edit user</h2>
</div>
<div class="w3-panel w3-gray" style="margin-top: 0;">
        <form method="post" class="w3-container">
        <input type="hidden" name="id" value="${user.getId()}">
            <label>Name</label>
            <input type="text" class="w3-input" value="${user.getName()}" name="name" />
            <lable>Age</lable>
            <input type="text" class="w3-input" value="${user.getAge()}" name="age" /> <br />
